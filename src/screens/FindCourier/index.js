...
const FindCourer = ({ navigation, route }) => {
    ...
    useEffect(() => {
        getUserOrder();
        dispatch({ type: 'add', item: [], costumer_coordinate: 0 });
    }, [])
                                                ...
                                                return (
                                                    <View key={i} style={{ padding: 6, borderWidth: 1, borderRadius: 10, borderColor: 'blue', marginBottom: 20 }}>
                                                        <View style={{ padding: 4 }}>
                                                            ...
                                                            <Text style={{ fontSize: 15, fontWeight: 'bold', letterSpacing: .4, marginTop: 5 }}>Status : {false ? 'belum dikirim' : 'sudah terkirim'}</Text>
                                                        </View>
                                                    </View>
                                                )
                                            })
